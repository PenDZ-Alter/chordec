...
#define API_H
  ...
  // All Shared libraries on Windows should use __declspec(dllexport) to export symbols and __declspec(dllimport) to import them. This macro handles that automatically.
    #if defined(chordec_parser_EXPORTS) || defined(chordec_gen_EXPORTS) || defined(chordec_math_EXPORTS) || defined(chordec_info_EXPORTS) || defined(chordec_export_EXPORTS)
